...
@Database(
    entities = [
        ...
        HomeCatalogCacheEntity::class,
        VodSearchCacheEntity::class,
        KinobotMessageEntity::class,
    ],
    version = 32,
    exportSchema = false,
)
abstract class ArkivDatabase : RoomDatabase() {
    ...
    abstract fun vodSearchCacheDao(): VodSearchCacheDao
    abstract fun kinobotDao(): KinobotDao
    ...
    companion object {
         ...
         */
        /**
         * v29 -> v30: adds `home_catalog_cache`, the persisted classified home catalog so a cold
         * start paints the last-known home instantly (see [HomeCatalogCacheEntity]). Local cache,
         * no sync triggers; created empty, filled on the first portal fetch.
         */
        private val MIGRATION_29_30 = object : Migration(29, 30) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "CREATE TABLE IF NOT EXISTS home_catalog_cache (" +
                        "id TEXT NOT NULL PRIMARY KEY, " +
        ...
        /**
         * v30 -> v31: adds `vod_search_cache`, the persisted VOD search results so a repeated
         * search answers from disk instead of the portal (see [VodSearchCacheEntity]). Local cache,
         * no sync triggers.
         */
        private val MIGRATION_30_31 = object : Migration(30, 31) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "CREATE TABLE IF NOT EXISTS vod_search_cache (" +
        ...
        /** v31 -> v32: adds `kinobot_messages`, the persisted Kinobot chat (see [KinobotMessageEntity]). */
